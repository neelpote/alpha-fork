  ...
  if (loading || !metrics || !riskData) {
    return (
      <div role="status" aria-live="polite" className="flex-1 flex flex-col items-center justify-center min-h-[60vh] text-accent-blue">
        ...
        <p className="text-gray-400 font-medium tracking-widest uppercase text-sm">Syncing On-Chain Data...</p>
      </div>
    );
  }
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 relative z-10">
            ...
            <div className="flex flex-wrap items-center gap-8 lg:gap-10 w-full lg:w-auto">
              <div>
                ...
                <p className="text-2xl font-bold text-white data-value">$125,000</p>
              </div>
              <div>
